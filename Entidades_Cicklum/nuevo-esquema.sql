...
CREATE TABLE Subentidad (ID BIGINT NOT NULL, DESCRIPCION VARCHAR(50) NOT NULL, DIFICULTAD VARCHAR(50) NOT NULL, DURACION_MINUTOS BIGINT NOT NULL, MATERIAL VARCHAR(50) NOT NULL, MULTIMEDIA LONGVARBINARY NOT NULL, MUSCULOS_TRABAJADOS VARCHAR(50) NOT NULL, NOMBRE VARCHAR(50) NOT NULL, REPETICIONES BIGINT NOT NULL, SERIES BIGINT NOT NULL, TIPO VARCHAR(50) NOT NULL, PRIMARY KEY (ID))
